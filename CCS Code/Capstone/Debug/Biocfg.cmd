...
_TSK_idle = TSK_idle;
_TSK_audProc = TSK_audProc;
_LNK_dataPump = LNK_dataPump;
_RTA_dispatcher = RTA_dispatcher;
_IDL_cpuLoad = IDL_cpuLoad;
_LOG_system = LOG_system;
_trace = trace;
_MBXinSamples = MBXinSamples;
_MBXpostProcess = MBXpostProcess;
_MBXdownsampled = MBXdownsampled;
...
SECTIONS {
       ...
       /* no HWI stubs are necessary */
        ...
        .TSK_audProc$stk: block(0x20000){
            *(.TSK_audProc$stk)
        } > DARAM PAGE 0

        .TSKUserInterface$stk: block(0x20000){
            *(.TSKUserInterface$stk)
        } > DARAM PAGE 0
       ...
       .hst0: block(0x20000) align = 0x4 {} > DARAM PAGE 0
        ...
        .MBXinSamples$que: block(0x20000) align = 0x4 {
            MBXinSamples$queElems = .;
            . += 208;
        } > DARAM PAGE 0

        .MBXpostProcess$que: block(0x20000) align = 0x4 {
            MBXpostProcess$queElems = .;
            . += 208;
        } > DARAM PAGE 0

        .MBXdownsampled$que: block(0x20000) align = 0x4 {
            MBXdownsampled$queElems = .;
            . += 264;
        } > DARAM PAGE 0
